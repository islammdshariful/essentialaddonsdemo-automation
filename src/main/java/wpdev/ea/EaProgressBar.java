...
public class EaProgressBar {
	public static void eaProgressBar(WebDriver driver, String url) {
		...
		try {
			...
			assertEquals(driver.findElement(By.xpath(eaProgressBarUtils.Locator.photoshop_progressbar_text_xpath)).getText(), eaProgressBarUtils.TEXT.photoshop_progressbar_text);
			assertEquals(driver.findElement(By.xpath(eaProgressBarUtils.Locator.photoshop_progressbar_number_xpath)).getText(), eaProgressBarUtils.TEXT.photoshop_progressbar_number);
			
			assertEquals(driver.findElement(By.xpath(eaProgressBarUtils.Locator.contentwritinng_progressbar_text_xpath)).getText(), eaProgressBarUtils.TEXT.contentwritinng_progressbar_text);
			assertEquals(driver.findElement(By.xpath(eaProgressBarUtils.Locator.contentwritinng_progressbar_number_xpath)).getText(), eaProgressBarUtils.TEXT.contentwritinng_progressbar_number);
