...
public class EaDataTable {
	public static void eaDataTable(WebDriver driver) {

		try {
			assertEquals(driver.getTitle(), eaDataTableUtils.TEXT.datatable_page_title);
			System.out.println("Page title passed !!");

			driver.findElement(By.xpath(eaDataTableUtils.Locator.documentation_link_path)).click();

			ArrayList<String> tabs2 = new ArrayList<String>(driver.getWindowHandles());
			driver.switchTo().window(tabs2.get(1));

			assertEquals(driver.findElement(By.id(eaDataTableUtils.Locator.documentation_title_id)).getText(),
					eaDataTableUtils.TEXT.documentation_page);
