...
public class EaCallToAction {
	public static void eaCallToAction(WebDriver driver, String url) {
		...
		try {
			...
			assertEquals(driver.findElement(By.xpath(eaCallToActionUtils.Locator.header_text_xpath)).getText(),
					eaCallToActionUtils.TEXT.header_text);
			assertEquals(driver.findElement(By.xpath(eaCallToActionUtils.Locator.description_text_xpath)).getText(),
